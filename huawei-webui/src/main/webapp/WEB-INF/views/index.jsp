...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="">HUAWEI</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="">H-ui</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li id="loginId_name"></li>
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
                            <li><a href="#">切换账户</a></li>
                            <li><a id="list_item_a" href="#">退出</a></li>
                        </ul>
                    </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="goods/goodsInfo" data-title="商品管理" href="javascript:void(0)">商品管理</a></li>
                    <li><a data-href="classify/classifyInfo" data-title="类型管理" href="javascript:void(0)">类型管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="product-brand.html" data-title="订单列表" href="javascript:void(0)">品牌管理</a></li>
    ...
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="">操作</span>
                    <em></em></li>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    // 显示当前登录账号
    var login_name=sessionStorage.getItem("loginId");
    $("#loginId_name").html(login_name);

    // 注销当前账号，清空session
    $("#list_item_a").click(function(){
        if (confirm("你确定要注销当前账号吗？")) {
            sessionStorage.removeItem("loginId");
            window.location.href="http://localhost:8080/admin/tologin";
            return true;
